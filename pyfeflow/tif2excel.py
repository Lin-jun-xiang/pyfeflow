...
def tif_to_xyz(tif_path: str, output: str, step: int = 3) -> None:
    """
    ...
    ----------
    tif_path (str):
        The path of the input GeoTIFF file.
    step (int):
        The sampling interval of the output data. Default is 3.

    Examples
    --------
    ```python
    from pyfeflow import tif_to_xyz

    tif_file = 'YOUR_TIFF_FILE.tiff'
    output_file = 'test.xlsx'
    tif_to_xyz(tif_file, output_file)
    ```
    """
